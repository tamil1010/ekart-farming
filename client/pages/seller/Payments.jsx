    ...
    <div className="space-y-8 animate-in fade-in duration-500 pb-20">
      <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          ...
          <p className="text-text-secondary mt-1 max-w-lg font-medium">Manage your store earnings, monitor settlement cycles, and request payouts.</p>
        </div>
        <button 
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <motion.div 
          ...
          className="glass-card bg-amber-500/5 border-amber-500/10 p-6 flex flex-col justify-between"
        >
          <div className="flex justify-between items-start">
          ...
          <div className="mt-8">
            <p className="text-[10px] font-black text-amber-500/70 uppercase tracking-widest mb-1">Pending (COD In-Transit)</p>
        ...
        >
          <div className="flex justify-between items-start">
            <div className="w-12 h-12 bg-white/5 rounded-2xl flex items-center justify-center text-text-muted">
               <ArrowDownRight className="w-6 h-6" />
            </div>
          </div>
          <div className="mt-8">
            <p className="text-[10px] font-black text-text-muted uppercase tracking-widest mb-1">Total Withdrawn</p>
